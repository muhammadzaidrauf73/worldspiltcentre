                  ...
                  {(() => {
                    ...
                    return (
                      <div className="mt-3 p-3 rounded bg-secondary border border-border space-y-1">
                        ...
                        <a
                          href={`https://wa.me/${whatsappNumber}?text=${encodeURIComponent('Hi, I have sent payment for my order. Here is the screenshot:')}`}
                          target="_blank"
                          rel="noopener noreferrer"
                          className="mt-2 inline-flex items-center gap-2 px-3 py-1.5 rounded bg-[#25D366] text-white text-xs font-medium hover:bg-[#20bd5a] transition-colors"
                        >
