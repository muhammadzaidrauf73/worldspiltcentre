import { AirVent, Tv, WashingMachine, Refrigerator, Microwave, Flame, Smartphone, LucideIcon } from "lucide-react";
...
const categories = [
  { id: "1", name: "TVs & Audio", icon: "Tv", product_count: 245, image_url: "https://images.unsplash.com/photo-1593359677879-a4bb92f829d1?w=200" },
  { id: "2", name: "Refrigerators", icon: "Refrigerator", product_count: 156, image_url: "https://images.unsplash.com/photo-1571175443880-49e1d25b2bc5?w=200" },
  { id: "3", name: "Washing Machines", icon: "WashingMachine", product_count: 89, image_url: "https://images.unsplash.com/photo-1626806787461-102c1bfaaea1?w=200" },
  { id: "4", name: "Air Conditioners", icon: "AirVent", product_count: 134, image_url: "https://images.unsplash.com/photo-1631545806609-11e3a851df1e?w=200" },
  { id: "5", name: "Microwaves", icon: "Microwave", product_count: 67, image_url: "https://images.unsplash.com/photo-1574269909862-7e1d70bb8078?w=200" },
  { id: "6", name: "Cooking", icon: "Flame", product_count: 198, image_url: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=200" },
  { id: "7", name: "Smartphones", icon: "Smartphone", product_count: 312, image_url: "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?w=200" },
];
...
const Index = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Top Categories */}
      <section className="py-10 bg-gradient-to-b from-muted/30 to-background" id="categories">
        <div className="container mx-auto px-4">
          ...
          <div className="relative">
            <div className="flex gap-4 md:gap-6 overflow-x-auto pb-4 scrollbar-hide scroll-smooth snap-x snap-mandatory">
            ...
            <div className="absolute top-0 right-0 h-full w-12 bg-gradient-to-l from-background to-transparent pointer-events-none hidden md:block" />
          </div>
        </div>
      </section>
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            <div>
              <div className="flex items-center gap-2 mb-2">
                <span className="bg-accent text-accent-foreground px-3 py-1 rounded-md text-sm font-bold animate-pulse">
                  Hot Deals
                </span>
              </div>
          ...
          <div className="relative overflow-hidden rounded-2xl gradient-hero p-8 md:p-12">
            ...
            <div className="relative z-10 max-w-xl">
              ...
              <p className="text-primary-foreground/80 mb-6">
                Found a lower price elsewhere? We'll match it! Shop with confidence at Ayan & Company Electronics.
              </p>
              <Link to="/products">
                <button className="bg-primary-foreground text-primary font-semibold px-6 py-3 rounded-lg hover:bg-primary-foreground/90 transition-smooth shadow-lg">
                  Shop Now
                </button>
              </Link>
            </div>
